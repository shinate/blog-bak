...
[bash]wget http://apache.mirror.phpchina.com/apr/apr-1.3.5.tar.gz  
...
[bash]wget http://apache.mirror.phpchina.com/apr/apr-util-1.3.7.tar.gz  
...
[bash]wget http://subversion.tigris.org/downloads/subversion-1.4.5.tar.gz  
...
[bash]wget http://apache.etoak.com/httpd/httpd-2.2.11.tar.gz  
...
LoadModule authz_svn_module modules/mod_authz_svn.so[/code]
...
[bash]svnadmin create /home/nuptsoft/subversion_project/test[/bash]

### 添加用户和密码

运行apache的htpasswd

[bash]/usr/local/webserver/apache_svn/bin/htpasswd -cm /home/nuptsoft/passwd admin  

/usr/local/webserver/apache_svn/bin/htpasswd -m /home/nuptsoft/passwd somebody[/bash]
